...
import work.Entities.Invitation;
import work.Entities.UserBlockedConnection;
import work.Entities.UserConnection;
    ...
    private void handleStatusChange(int invitationId, Invitation.Status newStatus) {
        ...
        switch (newStatus) {
            case ACCEPTED -> {
                ...
                new UserConnectionDAO().insertUserConnection(userConnection);
            ...
            case BLOCKED -> {
                ...
                new UserBlockedConnectionDAO().insertBlockedConnection(userBlockedConnection);
                invitationDAO.deleteInvitation(invitationId);
            }
            case PENDING -> {
