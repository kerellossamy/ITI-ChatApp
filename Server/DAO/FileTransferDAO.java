...
import work.Entities.FileTransfer;
...
public class FileTransferDAO {
    ...
    public static FileTransfer getFileById(int fileId) {
    ...
    public static List<FileTransfer> getAllFiles() {
    ...
    public static boolean updateFile(FileTransfer fileTransfer) {
