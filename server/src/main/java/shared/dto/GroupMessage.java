...
public class GroupMessage extends BaseMessage implements Serializable {
    ...
    public GroupMessage(int messageId, int senderId, int groupId, String messageContent, String fontStyle, String fontColor, String textBackground, int fontSize, boolean isBold, boolean isItalic, boolean isUnderlined, java.sql.Timestamp timestamp) {
